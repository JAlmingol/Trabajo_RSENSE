...
double datos1 [6][30], datos2 [6][30], datos3 [6][30];
...
void Tarea1( void * parameter ) {
  while (1) {
    if (interruptCounter > 0) {
      ...
      datos1[1][cont1] = double(ax) / 1000;
      datos1[2][cont1] = double(ay) / 1000;
      datos1[3][cont1] = double(az) / 1000;
      datos1[4][cont1] = double(gx) / 1000;
      datos1[5][cont1] = double(gy) / 1000;
      datos1[6][cont1] = double(gz) / 1000;

      datos2[1][cont2] = double(ax) / 1000;
      datos2[2][cont2] = double(ay) / 1000;
      datos2[3][cont2] = double(az) / 1000;
      datos2[4][cont2] = double(gx) / 1000;
      datos2[5][cont2] = double(gy) / 1000;
      datos2[6][cont2] = double(gz) / 1000;
