...
//int16_t ay = 0;
//int16_t az = 0;
int filas = 6, columnas = 50, filasm1 = 5, columnasm1 = 49; //si se modifica modificar tamaño de arrays
int cont1 = 0, cont2 = columnas/2, f, c;
double datos1 [6][50], datos2 [6][50], datos3 [6][50], media[6], varianza[6];
